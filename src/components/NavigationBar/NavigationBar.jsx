...
function NavigationBar({ componentToggle, setMore }) {
  const [showMoreDropDown, setShowDropDown] = useState(true);

  useEffect(() => {
    setShowDropDown(setMore);
  }, [setMore]);
      ...
      <Navbar expand="lg">
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="me-auto">
            ...
            <Nav.Link
              href="#fiction"
              onClick={() => handleComponentToggle("Fiction")}
            >
              Fiction
            </Nav.Link>
            ...
            {showMoreDropDown ? (
              <NavDropdown title="More" id="basic-nav-dropdown">
                <div style={{ maxHeight: "300px", overflowY: "auto" }}>
                  ...
                  <NavDropdown.Item
                    onClick={() =>
                      handleComponentToggle("christian_literature")
                    }
                  >
                  ...
                  <NavDropdown.Item
                    onClick={() => handleComponentToggle("love")}
                  >
                    Love
                  </NavDropdown.Item>
                  <NavDropdown.Item
